...
public class panelProduse extends JPanel {
	private ProduseAfisare afisare;
	private InserareProduse inserare;
	private DeleteProduse delete;
	/**
	 * Create the panel.
	 */
	public panelProduse() {
		...
		afisare = new ProduseAfisare();
		inserare = new InserareProduse();
		delete = new DeleteProduse();
