...
public class panelLocatii extends JPanel {
	private LocatiiAfisare afisare;
	private InserareLocatii inserare;
	private DeleteLocatii delete;
	private StatisticiLocatie statistici;
	/**
	 * Create the panel.
	 */
	public panelLocatii() {
		...
		afisare = new LocatiiAfisare();
		inserare = new InserareLocatii();
		delete = new DeleteLocatii();
		statistici = new StatisticiLocatie();
