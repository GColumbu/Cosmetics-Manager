...
public class panelClienti extends JPanel {
	private ClientiAfisare afisare;
	private InserareClienti inserare;
	private DeleteClienti delete;
	private UpdateClienti update;
	private StatisticiClienti statistici;
	/**
	 * Create the panel.
	 */
	public panelClienti() {
		...
		afisare = new ClientiAfisare();
		inserare = new InserareClienti();
		delete = new DeleteClienti();
		update = new UpdateClienti();
		statistici = new StatisticiClienti();
