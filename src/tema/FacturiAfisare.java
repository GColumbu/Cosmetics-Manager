...
public class FacturiAfisare extends JPanel {
	private JTable table_1;
	/**
	 * Create the panel.
	 */
	public FacturiAfisare() {
		...
		model.addColumn("Pret Total");
		model.addColumn("Metoda Plata");
		try
		{
			Connection con = DriverManager.getConnection(connectionUrl); 
			String query="select *, A.Nume as ANume, C.Nume as CNume from Factura F inner join Angajat A on A.ID_Angajat = F.ID_Angajat "
